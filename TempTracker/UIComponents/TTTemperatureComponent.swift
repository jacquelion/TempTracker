...
class TTTemperatureComponent: UIView {
    ...
    func setupConstraints() {
        label.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(tempTextField.snp.leading).offset(-12.0)
        }
        ...
        tempTypePicker.snp.makeConstraints { make in
            ...
            make.width.equalTo(tempTextField)
            make.leading.equalTo(tempTextField.snp.trailing).offset(12.0)
        }
    }
}
